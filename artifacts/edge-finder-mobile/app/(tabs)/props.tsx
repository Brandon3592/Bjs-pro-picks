...
const styles = StyleSheet.create({
  ...
  propPlayer: { fontSize: 15, fontFamily: "Inter_600SemiBold", letterSpacing: -0.2 },
  propMarket: { fontSize: 12, fontFamily: "Inter_500Medium", marginTop: 3 },
  propFooter: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  propOdds: { fontSize: 15, fontFamily: "Inter_700Bold" },
  propRight: { flex: 1, alignItems: "flex-end", gap: 3 },
