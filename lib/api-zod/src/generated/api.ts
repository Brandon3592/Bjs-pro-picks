 ...
 */
export const RefreshAiPicksResponse = zod.object({
  ok: zod.boolean(),
});
 ...
 */
export const GetPickHistoryResponseItem = zod.object({
  id: zod.number(),
  sport: zod.string(),
  gameId: zod.string().nullish(),
  homeTeam: zod.string(),
  ...
  betType: zod.string(),
  gameStartTime: zod.coerce.date(),
  result: zod.enum(["pending", "win", "loss"]),
  profit: zod.number().nullish(),
  createdAt: zod.coerce.date(),
});
export const GetPickHistoryResponse = zod.array(GetPickHistoryResponseItem);

/**
 * @summary Log an AI pick for performance tracking
 */
export const logPickBodyBetTypeDefault = `moneyline`;

export const LogPickBody = zod.object({
  sport: zod.string(),
  gameId: zod.string().nullish(),
  homeTeam: zod.string(),
  awayTeam: zod.string(),
  ...
  confidence: zod.number(),
  reasoning: zod.string().nullish(),
  betType: zod.string().default(logPickBodyBetTypeDefault),
  gameStartTime: zod.string(),
});

/**
 * @summary Get W/L/ROI stats for tracked AI picks
 */
export const GetPickHistoryStatsResponse = zod.object({
  wins: zod.number(),
  losses: zod.number(),
  pending: zod.number(),
  total: zod.number(),
 ...
 */
export const UpdatePickResultParams = zod.object({
  pickId: zod.coerce.number(),
});

export const UpdatePickResultBody = zod.object({
  result: zod.enum(["win", "loss", "pending"]),
  profit: zod.number().nullish(),
});

export const UpdatePickResultResponse = zod.object({
  id: zod.number(),
  sport: zod.string(),
  gameId: zod.string().nullish(),
  homeTeam: zod.string(),
